...
const { survey_patients } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('survey_patients');

// This file contains the logic of every route in Forest Admin for the collection survey_patients:
...
// Create a Survey Patient
router.post('/survey_patients', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Survey Patient
router.put('/survey_patients/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Survey Patient
router.delete('/survey_patients/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Survey Patients
router.get('/survey_patients', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Survey Patients
router.get('/survey_patients/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Survey Patient
router.get('/survey_patients/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Survey Patients
router.get('/survey_patients.csv', permissionMiddlewareCreator.export(), (request, response, next) => {

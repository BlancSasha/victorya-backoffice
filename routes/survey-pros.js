...
const { survey_pros } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('survey_pros');

// This file contains the logic of every route in Forest Admin for the collection survey_pros:
...
// Create a Survey Pro
router.post('/survey_pros', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Survey Pro
router.put('/survey_pros/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Survey Pro
router.delete('/survey_pros/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Survey Pros
router.get('/survey_pros', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Survey Pros
router.get('/survey_pros/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Survey Pro
router.get('/survey_pros/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Survey Pros
router.get('/survey_pros.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
